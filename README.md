...
|               | type               | Integer particle type identifier. A particle with type 1 is considered part of a wall and will be fixed.            |
...
|               | typeDisc           | Particle type identifier for disc particles. A particle with type 1 is considered part of a wall and will be fixed. |
|               |                    |                                                                                                                     |
| types         | id                 | Particle id. A particle with type 1 is considered part of a wall and will be fixed.                                 |
