 ...
 *
 * This class provides a static helper function to generate a 3D rectangular grid
 * (cuboid) of particles with Brownian-initialized velocities.
 */
...
public:
   ...
   * @param brownianMean   Mean value for the Brownian Motion (Maxwell-Boltzmann).
