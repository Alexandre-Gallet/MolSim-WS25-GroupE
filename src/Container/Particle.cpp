...
Particle::Particle(const Particle &other) {
  ...
  // Copy neighbor references (raw pointers) for completeness; they may be reinitialized by generators.
...
void Particle::addNeighbor(Particle *neighbor, double rest_length) {
  neighbors_.push_back(Neighbor{neighbor, rest_length});
}

void Particle::clearNeighbors() { neighbors_.clear(); }

std::vector<Particle::Neighbor> &Particle::getNeighbors() { return neighbors_; }

const std::vector<Particle::Neighbor> &Particle::getNeighbors() const { return neighbors_; }
